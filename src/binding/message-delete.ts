...
export type MessageDeleteQueryResult =
...
export const messageDeleteQueryResultParse = (result: MessageDeleteQueryResult): MessageDeleteResult => {
...
export const messageDelete = async (params: {
    ...
    `).then(res => res.rows[0].result) as MessageDeleteQueryResult
    return messageDeleteQueryResultParse(result)
}
